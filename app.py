...
def upload_image():
    ...
    #                                                 target_size = (150, 150))
    print(test_image)
    test_image2 = test_image.resize((28,28))
    test_image1 = test_image.resize((28,28))
    loaded_model1 = keras.models.load_model('my_model.h5')
    ...
    print("Hi ",test_image1)
    result1 = loaded_model1.predict(test_image1)
...
#   print(class_idx)
    ...
    return render_template('result.html', tumor_type1=class_label1,tumor_type2=class_label2)
